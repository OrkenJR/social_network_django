...
urlpatterns = [
    ...
    path('post/new_group/<int:pk>', PostCreationGroup.as_view(), name='post_create_group'),
    path('post/delete/<int:pk>', PostDeleteView.as_view(), name='post_delete'),
    # path('post_group/delete/<int:pk>', PostGroupDeleteView.as_view(), name='post_delete'),
    ...
    path('groups/new', GroupCreation.as_view(), name='new_group'),
